...
public class SocketThread extends Thread {
    ...
    public SocketThread(BluetoothSocket socket, Handler socketHandler) {
        ...
        try {
        	...
        	Log.d("Socket","Streams Open: "+e.getMessage());
        }
    ...
    public void run() {
        ...
        while (true) {
            try {
                ...
                mmSocketHandler.obtainMessage(MESSAGE_READ, bytes, -1, buffer).sendToTarget();
            } catch (IOException e) {
            	Log.d("Socket","Read: "+e.getMessage());
                break;
            }
        }
    }
    ...
    public void write(byte[] bytes) {
        try {
        	...
        	Log.d("Socket","Write: "+e.getMessage());        	        	
        }
    }
    ...
    public void cancel() {
        try {
        	...
        	Log.d("Socket","Close: "+e.getMessage());        	
        }
    }
}